...
unsigned int WpiPinsSelection[] = {8,10};   		  // List of GPIO used by buttons in Wpi semantics
...
// following pins assignation is probably good only for Orange Pi Lite2/OnePlus
